...
description: How authentication works across Arkenos services.
---

# Authentication

Arkenos uses [Better Auth](https://better-auth.com) for authentication, with a clear separation between auth data and business data.
