...
The voice pipeline is the core of Nenyax — it processes audio in real-time between the caller and the AI agent.
...
Converts caller audio to text. Nenyax supports three providers, configurable per agent:
