...
4. Add credentials via the **Arkenos Dashboard** at **Settings > API Keys > LiveKit**
...
- LiveKit credentials are configured at **Settings > API Keys** and the **Test Connection** button shows success
