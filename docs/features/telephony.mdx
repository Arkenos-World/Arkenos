...
Nenyax supports real phone calls through Twilio and LiveKit SIP. The SIP infrastructure (trunks, dispatch rules, credentials) is **auto-provisioned** — you just need Twilio and LiveKit account credentials.
...
2. LiveKit's dispatch rule creates a room and dispatches `nenyax-agent`
