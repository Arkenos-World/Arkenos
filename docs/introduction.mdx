...
<CardGroup cols={2}>
  <Card title="Cloud Deploy" icon="cloud" iconType="solid" href="https://railway.com/deploy/nenyax">
    Deploy to Railway with one click — zero config required.
  </Card>
  <Card title="Quick Start" icon="rocket" iconType="solid" href="/quickstart"> 
    Get Nenyax running with Docker Compose in under 5 minutes.
  </Card> 
