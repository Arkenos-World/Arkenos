          ...
          <div className="container mx-auto px-4 pt-20 pb-12 lg:pt-28 lg:pb-16">
            ...
            >
              <motion.div variants={fadeUp} className="flex items-center gap-3 mb-6">
                <Badge className="bg-zinc-50 text-zinc-600 border border-black/5 hover:bg-zinc-100 dark:bg-zinc-800/50 dark:text-zinc-400 dark:border-white/[0.06] dark:hover:bg-zinc-800 shadow-sm">Philosophy</Badge>
                <span className="text-sm text-zinc-500 dark:text-zinc-400">10 min read</span>
              </motion.div>
