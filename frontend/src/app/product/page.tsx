      ...
      <main>
          ...
          <div className="container mx-auto px-4 pt-20 pb-16 lg:pt-28 lg:pb-24">
            ...
            >
              <motion.div variants={fadeUp}>
                <Badge className="bg-zinc-50 text-zinc-600 border border-black/5 hover:bg-zinc-100 shadow-sm mb-4">Product</Badge>
              </motion.div>
              <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6">
                The full picture
              </motion.h1>
              <motion.p variants={fadeUp} className="text-lg sm:text-xl text-zinc-500 mb-8 max-w-2xl mx-auto">
                How Nenyax works, what it costs, how it compares to Vapi and Retell, and what you can build with it.
              </motion.p>
              <motion.div variants={fadeUp} className="flex flex-wrap items-center justify-center gap-3 text-sm text-zinc-500">
                {["How it works", "Use cases", "Tech specs", "Pricing", "Comparison"].map((item) => (
                  <span key={item} className="px-3 py-1 border border-black/5 bg-white">{item}</span>
                ))}
              </motion.div>
            </motion.div>
          </div>
        ...
        <section className="border-t border-black/5">
          <div className="container mx-auto px-4 py-20 lg:py-28">
            ...
            >
              <motion.div variants={fadeUp}>
                <Badge className="bg-zinc-50 text-zinc-600 border border-black/5 hover:bg-zinc-100 shadow-sm mb-4">How It Works</Badge>
              </motion.div>
              <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                Describe it. We build it.
              </motion.h2>
              <motion.p variants={fadeUp} className="mx-auto max-w-2xl text-lg text-zinc-500">
            ...
            <div className="max-w-4xl mx-auto grid lg:grid-cols-2 gap-8">
              ...
              >
                <div className="border border-black/5 bg-white p-6">
                  <p className="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-3">Your prompt</p>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    >
                      <div className="h-8 w-8 border border-black/5 bg-white flex items-center justify-center flex-shrink-0 text-sm font-bold">
                        {item.step}
                      </div>
                      <div>
              ...
              <motion.div
                ...
                className="border border-black/5 bg-white overflow-hidden"
              >
                <div className="px-4 py-3 border-b border-black/5 bg-muted/30 flex items-center gap-2">
                  <FolderIcon className="h-4 w-4 text-primary" />
                  <span className="text-xs font-medium">Generated Agent</span>
                  <span className="ml-auto text-xs text-zinc-500">{AGENT_FILES.length} files</span>
                </div>
                <div className="p-4 font-mono text-xs space-y-0.5">
                  {AGENT_FILES.map((file, i) => (
                    ...
                    >
                      ...
                      <span className={file.isDir ? "text-chart-5 font-medium" : "text-zinc-900"}>
                        {file.name}
                      </span>
                      {file.snippet && (
                        <span className="text-zinc-500 ml-2 truncate hidden sm:inline">
                          — {file.snippet}
                        </span>
                      )}
                    </motion.div>
                ...
                <div className="px-4 py-3 border-t border-black/5 bg-muted/30">
        ...
        {/* ── Use Cases ───────────────────────────────────────────────────── */}
        <section className="border-t border-black/5 bg-muted/30">
          <div className="container mx-auto px-4 py-20 lg:py-28">
            <motion.div
              initial="hidden"
              whileInView="visible"
            ...
            >
              <motion.div variants={fadeUp}>
                <Badge className="bg-zinc-50 text-zinc-600 border border-black/5 hover:bg-zinc-100 shadow-sm mb-4">Use Cases</Badge>
              </motion.div>
              <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                What you can build
              </motion.h2>
            ...
            <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
              {USE_CASES.map((uc, i) => (
                ...
                >
                  {/* Header */}
                  <div className="px-6 py-4 border-b border-black/5 bg-muted/30 flex items-center gap-3">
                  ...
                  <div className="p-6 space-y-4">
                    {/* Caller says */}
                    <div>
                      <p className="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-1">Caller</p>
                      <p className="text-sm">&quot;{uc.caller}&quot;</p>
                    </div>

                    {/* Agent executes */}
                    <div>
                      <p className="text-xs font-medium text-zinc-500 uppercase tracking-wider mb-2">Agent executes</p>
                    ...
                    <div className="pt-3 border-t border-black/5">
                      <p className="text-sm text-zinc-500">{uc.result}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        <section className="border-t border-black/5">
          <div className="container mx-auto px-4 py-20 lg:py-28">
            ...
            >
              <motion.div variants={fadeUp}>
                <Badge className="bg-zinc-50 text-zinc-600 border border-black/5 hover:bg-zinc-100 shadow-sm mb-4">Technical Specs</Badge>
              </motion.div>
              <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="border border-black/5 bg-white p-6 text-center"
                >
        ...
        <section className="border-t border-black/5 bg-muted/30">
          <div className="container mx-auto px-4 py-20 lg:py-28">
            ...
            >
              <motion.div variants={fadeUp}>
                <Badge className="bg-zinc-50 text-zinc-600 border border-black/5 hover:bg-zinc-100 shadow-sm mb-4">Pricing</Badge>
              </motion.div>
              <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                You pay $0 to Nenyax
              </motion.h2>
              ...
              <table className="w-full text-sm border border-black/5">
                ...
                <tbody>
                  {[
                    ...
                    <tr key={i} className={`border-b border-black/5 last:border-0 ${i === 5 ? "bg-primary/5 font-semibold" : ""}`}>
                      {row.map((cell, j) => (
                        <td key={j} className={`px-4 py-3 ${j === 0 ? "text-left" : "text-center"} ${j > 0 && i < 5 ? "text-zinc-500" : ""}`}>
                          {cell}
                        </td>
                      ))}
                    </tr>
        ...
        <section className="border-t border-black/5">
          <div className="container mx-auto px-4 py-20 lg:py-28">
            ...
            >
              <motion.div variants={fadeUp}>
                <Badge className="bg-zinc-50 text-zinc-600 border border-black/5 hover:bg-zinc-100 shadow-sm mb-4">Comparison</Badge>
              </motion.div>
              <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                    ...
                    <tr key={i} className="border-b border-black/5 last:border-0">
                      ...
                      <td className={`px-4 py-3 text-center ${row.win ? "bg-primary/5" : ""}`}>
                        {typeof row.nenyax === "boolean" ? (
                          ...
                          <span className={row.win ? "font-medium text-zinc-900" : "text-zinc-500"}>{row.nenyax}</span>
                        )}
                      </td>
                      <td className="px-4 py-3 text-center">
                        {typeof row.vapi === "boolean" ? (
                          ...
                          <span className="text-zinc-500">{row.vapi}</span>
                        )}
                      </td>
                      <td className="px-4 py-3 text-center">
                        {typeof row.retell === "boolean" ? (
                          ...
                          <span className="text-zinc-500">{row.retell}</span>
                        )}
                      </td>
                    </tr>
                  ))}
            ...
            <div className="max-w-4xl mx-auto mt-6 text-center">
              <Link href="/blog/voice-ai-landscape-2026" className="text-sm text-zinc-500 hover:text-zinc-900 transition-colors underline underline-offset-4">
        ...
        <section className="border-t border-black/5 bg-muted/30">
          <div className="container mx-auto px-4 py-20 lg:py-28">
            ...
            >
              ...
              <p className="mx-auto max-w-xl text-lg text-zinc-500 mb-8">
