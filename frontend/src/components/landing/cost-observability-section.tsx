...
export function CostObservabilitySection() {
  return (
    <section className="py-24 md:py-32 bg-white border-t border-black/5 w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          <div className="rounded-[2rem] bg-stone-50 border border-black/5 p-8 md:p-12 shadow-sm flex flex-col group transition-all duration-300 hover:shadow-md hover:border-black/10">
            ...
            <div className="flex flex-col border border-black/5 rounded-2xl overflow-hidden bg-white shadow-sm mt-auto">
              ...
              {[
                ...
                { layer: "Intelligence", nenyax: "Google Gemini", alt: "Locked / Bundled" },
          ...
          <div className="rounded-[2rem] bg-white p-8 md:p-12 shadow-sm border border-black/5 flex flex-col relative overflow-hidden group hover:shadow-md hover:border-black/10 transition-all duration-300">
            ...
            <div className="flex items-center gap-3 mb-10 relative z-10">
               <div className="w-10 h-10 rounded-full bg-stone-50 flex items-center justify-center text-zinc-900 border border-black/5 group-hover:scale-105 transition-transform duration-300 shadow-sm">
                 <BarChart3 className="w-4 h-4" />
               </div>
               <div>
                 <h3 className="text-[17px] font-medium text-zinc-900">Cost Observability</h3>
                 <p className="text-[13px] text-zinc-500">Per-session telemetry</p>
               </div>
            </div>

            {/* Mock UI */}
            <div className="mt-auto w-full bg-stone-50 rounded-2xl border border-black/5 p-6 md:p-8 shadow-sm flex flex-col gap-6 relative z-10">
              <div className="flex items-end justify-between border-b border-black/5 pb-5">
                <div>
                  <div className="text-[11px] font-mono text-zinc-400 mb-1 uppercase tracking-wider">SESSION: <span className="text-zinc-900 font-medium">call_9281x</span></div>
                  <div className="text-3xl md:text-4xl font-medium text-zinc-900 tracking-tight">$0.042</div>
                </div>
                <div className="text-[11px] md:text-[12px] font-mono text-emerald-600 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-100 flex items-center gap-2">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="space-y-2.5">
                  <div className="flex justify-between text-[13px] font-medium">
                    <span className="text-zinc-800">Google Gemini (LLM)</span>
                    <span className="text-zinc-900 font-medium">$0.012</span>
                  </div>
                ...
                <div className="space-y-2.5">
                  <div className="flex justify-between text-[13px] font-medium">
                    <span className="text-zinc-800">Resemble AI (TTS)</span>
                    <span className="text-zinc-900 font-medium">$0.022</span>
                  </div>
                  <div className="w-full h-1.5 bg-black/5 rounded-full overflow-hidden">
                ...
                <div className="space-y-2.5">
                  <div className="flex justify-between text-[13px] font-medium">
                    <span className="text-zinc-800">Deepgram (STT)</span>
                    <span className="text-zinc-900 font-medium">$0.008</span>
                  </div>
                  <div className="w-full h-1.5 bg-black/5 rounded-full overflow-hidden">
